...
Existem várias maneiras de obter ajuda no R/Rstudio:
...
<div class="exercise-box">Exercício: Peça ajuda para a função `sqrt` (raiz-quadrada)
...
**Dica:** Tem cuidado de não esquecer o traço no "<-".
</div>
...
```
<div class="observation-box">Obs: substituir os "___" com o valor apropriado.</div>
</div>
...
<div class="observation-box">Obs: a partir dagora terá opção de corregir o seu trabalho através do botão "Enviar resposta" no canto inferior direito do exercício.</div>
